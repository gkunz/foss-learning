...
1. <a name="ref_2">[The Git Book](https://git-scm.com/book/en/v2)</a>
1. <a name="ref_3">[Learn Git Branching](https://learngitbranching.js.org/)</a>
1. <a name="ref_4">[The Multibillion Dollar Software Supply Chain of Ethereum](https://arxiv.org/abs/2202.07029)</a>
