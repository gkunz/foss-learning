...
holding the corresponding `private` key can decrypt it. This guarantees the _confidentiality_ of the information.
...
* Use in messaging services such signal, telegram, whatsapp and many more.
...
1. [What is PKI](https://www.technologyies.com/what-is-pki-infrastructure-and-how-does-it-work/)
1. [Certificate Authority](https://en.wikipedia.org/wiki/Certificate_authority)
1. [Intelligent Transportation System (ITS)](https://en.wikipedia.org/wiki/Intelligent_transportation_system)
1. [What is a CRL](https://www.rfc-editor.org/rfc/rfc5280)
1. [The use of CRLs and OCSP in PKI](https://www.keyfactor.com/blog/what-is-a-certificate-revocation-list-crl-vs-ocsp/)
